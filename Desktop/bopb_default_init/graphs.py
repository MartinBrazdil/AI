...
fig.savefig('bopb_egevmc_default_init.png', dpi=100)
plt.show()
...
fig.savefig('bopb_osegevmc_default_init.png', dpi=100)
plt.show()
...
fig.savefig('bopb_osegfvmc_default_init.png', dpi=100)
plt.show()

fig, ax1 = plt.subplots(1,1,figsize=(12,3))
scatter(ax1, osgevmc_evolution[:,0], 'Gamma', osgevmc_evolution[:,1], 'Fitness')
fig.savefig('bopb_osgevmc_default_init.png', dpi=100)
plt.show()

fig, ax1 = plt.subplots(1,1,figsize=(12,3))
scatter(ax1, osgfvmc_evolution[:,0], 'Gamma', osgfvmc_evolution[:,1], 'Fitness')
fig.savefig('bopb_osgfvmc_default_init.png', dpi=100)
plt.show()
...
plt.ylabel('Reward')
plt.tight_layout()
fig.savefig('bopb_agents_default_init.png', dpi=100)
plt.show()

# As ordered around iteration 10: Bottom line is RU agent. Four in the middle are OSEGFVMC, OSGFVMC (lower two) and OSEGEVMC, OSGEVMC (upper two). Top four are from bottom up EGFVMC, GFVMC, EGEVMC and GEVMC agents.
