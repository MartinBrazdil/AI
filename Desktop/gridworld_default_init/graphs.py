...
fig.savefig('gridworld_egevmc_default_init.png', dpi=100)
plt.show()
...
fig.savefig('gridworld_osegevmc_default_init.png', dpi=100)
plt.show()
...
fig.savefig('gridworld_osegfvmc_default_init.png', dpi=100)
plt.show()

fig, ax1 = plt.subplots(1,1,figsize=(12,3))
scatter(ax1, osgevmc_evolution[:,0], 'Gamma', osgevmc_evolution[:,1], 'Fitness')
fig.savefig('gridworld_osgevmc_default_init.png', dpi=100)
plt.show()

fig, ax1 = plt.subplots(1,1,figsize=(12,3))
scatter(ax1, osgfvmc_evolution[:,0], 'Gamma', osgfvmc_evolution[:,1], 'Fitness')
fig.savefig('gridworld_osgfvmc_default_init.png', dpi=100)
plt.show()
...
plt.ylabel('Reward')
plt.tight_layout()
fig.savefig('gridworld_agents_default_init.png', dpi=100)
plt.show()
