...
fig.savefig('bandit_egevmc.png', dpi=100)
plt.show()
...
fig.savefig('bandit_osegevmc.png', dpi=100)
plt.show()
...
plt.ylabel('Reward')
plt.tight_layout()
fig.savefig('bandit_agents.png', dpi=100)
plt.show()
