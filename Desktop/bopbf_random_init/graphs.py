...
fig.savefig('bopbf_egevmc_random_init.png', dpi=100)
plt.show()
...
fig.savefig('bopbf_osegevmc_random_init.png', dpi=100)
plt.show()
...
fig.savefig('bopbf_osegfvmc_random_init.png', dpi=100)
plt.show()

fig, ax1 = plt.subplots(1,1,figsize=(12,3))
scatter(ax1, osgevmc_evolution[:,0], 'Gamma', osgevmc_evolution[:,1], 'Fitness')
fig.savefig('bopbf_osgevmc_random_init.png', dpi=100)
plt.show()

fig, ax1 = plt.subplots(1,1,figsize=(12,3))
scatter(ax1, osgfvmc_evolution[:,0], 'Gamma', osgfvmc_evolution[:,1], 'Fitness')
fig.savefig('bopbf_osgfvmc_random_init.png', dpi=100)
plt.show()
...
plt.ylabel('Reward')
plt.tight_layout()
fig.savefig('bopbf_agents_random_init.png', dpi=100)
plt.show()

# As ordered at last iteration: At bottom there are (without order) RU, OSEGEVMC, OSEGFVMC, OSGFVMC and OSGEVMC agents. At top there are (without order) EGEVMC, EGFVMC, GFVMC and GEVMC.