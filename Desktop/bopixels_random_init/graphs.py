...
fig.savefig('bopixels_egevmc_random_init.png', dpi=100)
plt.show()
...
fig.savefig('bopixels_osegevmc_random_init.png', dpi=100)
plt.show()
...
fig.savefig('bopixels_osegfvmc_random_init.png', dpi=100)
plt.show()

fig, ax1 = plt.subplots(1,1,figsize=(12,3))
scatter(ax1, osgevmc_evolution[:,0], 'Gamma', osgevmc_evolution[:,1], 'Fitness')
fig.savefig('bopixels_osgevmc_random_init.png', dpi=100)
plt.show()

fig, ax1 = plt.subplots(1,1,figsize=(12,3))
scatter(ax1, osgfvmc_evolution[:,0], 'Gamma', osgfvmc_evolution[:,1], 'Fitness')
fig.savefig('bopixels_osgfvmc_random_init.png', dpi=100)
plt.show()
...
plt.ylabel('Reward')
plt.tight_layout()
fig.savefig('bopixels_agents_random_init.png', dpi=100)
plt.show()
