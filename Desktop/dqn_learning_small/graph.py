...
plt.tight_layout()
plt.show()
fig.savefig('one_layer_performance_small.png', dpi=100)
...
plt.tight_layout()
plt.show()
fig.savefig('two_layers_performance_small.png', dpi=100)
...
plt.tight_layout()
plt.show()
fig.savefig('conv_perc_performance_small.png', dpi=100)
